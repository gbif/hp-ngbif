...
[![Build Status](https://builds.gbif.org/job/hp-ngbif/badge/icon)](https://builds.gbif.org/job/hp-ngbif/lastBuild/console)
...
# GBIF Hosted Portal: hp-ngbif

This Jekyll website, **[hp-ngbif](https://hp-ngbif.gbif.org/)**, makes use of a theme and biodiversity widgets developed by the GBIF network.
